...
public class SignUpActivity extends BaseActivity implements View.OnClickListener {
    ...
    Typeface face;
    EditText name_edt, email_edt, password_edt,
            phone_edt, username_edt, lastname_edt;
    TextView static_text, sign_in;
    Button create_btn;
    TextInputLayout name_layout, email_layout, password_layout,
            lastname_layout, username_layout, phone_layout;
    Boolean isConnected;
            ...
            public void onClick(View view) {
                ...
                if (selectedId == -1) {
                    ...
                    if (isConnected) {
                        ...
                        CallSignUpAPI(firstname, lastname, email, username, password, phonenumber);
                    } else {
    ...
    private void CallSignUpAPI(String firstname, String lastname, String email, String username, String password, String phoneno) {
        /*http://phphosting.osvin.net/JSKT/API/SignUp.php?firstname=Ekam&lastname=Kaur
        &email=ekamkaur563@gmail.com&username=EkamKaur&password=ekamkaur&phone=9876543210&roleid=1*/
